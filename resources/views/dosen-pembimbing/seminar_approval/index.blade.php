                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Usulan Jadwal (Mhs)</th>
                        ...
                        @forelse ($seminarApplications as $seminar)
                            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="px-6 py-4 align-top whitespace-nowrap">{{ \Carbon\Carbon::parse($seminar->tanggal_pengajuan_seminar)->isoFormat('D MMM YY') }}</td>
                                ...
                                <td class="px-6 py-4 align-top">{{ Str::limit($seminar->judul_kp_final, 35) }}</td>
                                ...
                                <td class="px-6 py-4 align-top">
                                    ...
                                    @elseif($seminar->status_pengajuan == 'revisi_dospem')
                                        <span class="bg-orange-100 text-orange-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-orange-900 dark:text-orange-300">Anda Minta Revisi</span>
                                    @else
                                ...
                                <td class="px-6 py-4 align-top text-center">
                                    <a href="{{ route('dosen.pembimbing.seminar-approval.showForm', $seminar->id) }}" class="inline-flex items-center text-white {{ $seminar->status_pengajuan == 'diajukan_mahasiswa' || $seminar->status_pengajuan == 'revisi_dospem' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-400 hover:bg-gray-500' }} focus:ring-4 font-medium rounded-lg text-xs px-3 py-1.5 transition-colors duration-150">
                                        ...
                                        {{ $seminar->status_pengajuan == 'diajukan_mahasiswa' || $seminar->status_pengajuan == 'revisi_dospem' ? 'Proses' : 'Lihat Detail' }}
                                    </a>
                                </td>
                            </tr>
                        @empty
                            <tr class="border-b dark:border-gray-700">
                                <td colspan="7" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                    Tidak ada pengajuan seminar yang sesuai dengan filter.
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
