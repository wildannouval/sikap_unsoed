...
@section('title', 'Daftar Bimbingan KP')
        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 border-b dark:border-gray-700">
                    <h2 class="text-xl font-semibold text-gray-700 dark:text-white">Daftar Mahasiswa Bimbingan Kerja Praktek</h2>
                </div>
                ...
                <form method="GET" action="{{ route('dosen-pembimbing.bimbingan-kp.index') }}">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 p-4">
                        <div class="md:col-span-2">
                            <label for="search" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cari (Nama Mhs/NIM/Judul KP)</label>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @forelse ($pengajuanKps as $pengajuan)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ Str::limit($pengajuan->judul_kp, 35) }}</td>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <a href="{{ route('dosen-pembimbing.bimbingan-kp.konsultasi.show', $pengajuan->id) }}" class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-indigo-500 dark:hover:bg-indigo-600 focus:outline-none dark:focus:ring-indigo-800">
                                        Lihat Konsultasi
                                    </a>
                                </td>
                            </tr>
