                ...
                <div class="flex items-center ms-4">
                    ...
                    <div class="bg-white z-50 dark:bg-gray-700 dark:divide-gray-600 divide-gray-100 divide-y hidden list-none my-4 rounded-sm shadow-sm text-base" id="dropdown-user">
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                {{-- UBAH HREF INI --}}
                                <a class="hover:bg-gray-100 text-sm block dark:hover:bg-gray-600 dark:hover:text-white dark:text-gray-300 px-4 py-2 text-gray-700" href="{{ route('profile.edit') }}" role="menuitem">Profil Saya</a>
                            </li>
                            <li>
