            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-xl sm:rounded-lg overflow-hidden">
                ...
                <form action="{{ route('mahasiswa.pengajuan-kp.seminar.store', $pengajuanKp->id) }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="catatan_mahasiswa" id="catatan_mahasiswa" rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('catatan_mahasiswa') border-red-500 @enderror" placeholder="Misal: preferensi waktu tertentu, atau info tambahan...">{{ old('catatan_mahasiswa') }}</textarea>
                    ...
                    <div class="flex items-center space-x-4 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <a href="{{ route('mahasiswa.seminar.index') }}"
                           class="inline-flex items-center text-gray-700 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 border border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 transition-colors duration-150">
