...
@section('content')
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-xl sm:rounded-lg overflow-hidden p-4 sm:p-6">
            ...
            <form action="{{ Auth::user()->role == 'bapendik' ? route('bapendik.laporan.index') : route('dosen.komisi.laporan.index') }}" method="GET">
                ...
                <div class="mt-6 flex items-center space-x-4">
                    ...
                    <a href="{{ Auth::user()->role == 'bapendik' ? route('bapendik.laporan.index') : route('dosen.komisi.laporan.index') }}" class="text-sm text-gray-500 hover:underline dark:text-gray-400">Reset Filter</a>
                </div>
            </form>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-xl sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 border-b dark:border-gray-700">
                    ...
                    @if(!$pengajuanKps->isEmpty())
                        <a href="{{ route('bapendik.laporan.export-kp', request()->query()) }}" class="inline-flex items-center text-white bg-green-600 hover:bg-green-700 font-medium rounded-lg text-sm px-5 py-2.5">
