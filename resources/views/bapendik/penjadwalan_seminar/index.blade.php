                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    @if($seminar->status_pengajuan == 'dijadwalkan_komisi')
                                        <a href="{{ route('bapendik.penjadwalan-seminar.exportBeritaAcaraWord', $seminar->id) }}" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-1.5 mb-1 inline-block dark:bg-green-500 dark:hover:bg-green-600 focus:outline-none dark:focus:ring-green-800" target="_blank">
                                            Export Blangko BA
                                        </a>
                                    @endif
                                </td>
