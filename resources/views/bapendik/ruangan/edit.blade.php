        ...
        <div class="mx-auto max-w-none px-4 lg:px-6 py-4">
            <div class="bg-white dark:bg-gray-800 relative shadow-xl sm:rounded-lg overflow-hidden">
                <div class="p-4 sm:p-6 border-b dark:border-gray-700">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Edit Data Ruangan: {{ $ruangan->nama_ruangan }}</h2>
                </div>
                ...
                <form action="{{ route('bapendik.ruangan.update', $ruangan->id) }}" method="POST" class="p-4 sm:p-6">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_ruangan" id="nama_ruangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 @error('nama_ruangan') border-red-500 @enderror" value="{{ old('nama_ruangan', $ruangan->nama_ruangan) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi_gedung" id="lokasi_gedung" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" value="{{ old('lokasi_gedung', $ruangan->lokasi_gedung) }}">
                        ...
                        <div>
                            ...
                            <input type="number" name="kapasitas" id="kapasitas" min="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" value="{{ old('kapasitas', $ruangan->kapasitas) }}">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="fasilitas" id="fasilitas" rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600">{{ old('fasilitas', $ruangan->fasilitas) }}</textarea>
